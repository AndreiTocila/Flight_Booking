...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<Long, PaymentValidation> paymenetValidationProducerFactory()
    {
        return new DefaultKafkaProducerFactory<>(getAvroProducerProperties(LongSerializer.class));
    }
    @Bean
    public KafkaTemplate<Long, PaymentValidation> paymentValidationKafkaTemplate()
    {
        return new KafkaTemplate<>(paymenetValidationProducerFactory());
    }

    @Bean
    public ProducerFactory<String, String> paymenetNotificationProducerFactory()
    {
        return new DefaultKafkaProducerFactory<>(getProducerProperties(StringSerializer.class, StringSerializer.class));
    }
    @Bean
    public KafkaTemplate<String, String> paymentNotificationKafkaTemplate()
    {
        return new KafkaTemplate<>(paymenetNotificationProducerFactory());
    }
