package com.hcl.flightsearch.dto;
...
public class SearchCriteriaDTO {
    ...
    public SearchCriteriaDTO(LocalDateTime departureFrom, LocalDateTime departureTo) {
        this.departureFrom = departureFrom;
        this.departureTo = departureTo;
    }

    public SearchCriteriaDTO(String departureAirport, String arrivalAirport) {
        this.departureAirport = departureAirport;
        this.arrivalAirport = arrivalAirport;
    }

    public SearchCriteriaDTO(String departureAirport, String arrivalAirport, LocalDateTime departureFrom, LocalDateTime departureTo) {
        this.departureAirport = departureAirport;
        this.arrivalAirport = arrivalAirport;
        this.departureFrom = departureFrom;
        this.departureTo = departureTo;
